...
let OrdersController = class OrdersController {
    ...
    findAllByUser(userId, page, limit) {
        return this.ordersService.findAllByUser(userId, page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 10);
    }
    findAllAdmin(page, limit, status, search) {
        return this.ordersService.findAllAdmin(page ? parseInt(page, 10) : 1, limit ? parseInt(limit, 10) : 10, status, search);
    }
    getStats() {
